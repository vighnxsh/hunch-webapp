                        ...
                        >
                            ...
                            >
                                {user.avatarUrl ? (
                                    ...
                                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-cyan-500 to-blue-500 flex items-center justify-center border-2 border-cyan-500/30 transition-transform group-hover:scale-105">
